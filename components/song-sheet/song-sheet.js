...
export default class SongSheet extends BaseComponent {
    constructor() {
            ...
            <div class="song-sheet-container">
                ...
                <div class="sheet-content-wrapper">
                    <div class="song-sheet" id="song-content">
                        <!-- Main song content will be populated here -->
                    </div>
                    
                    <div class="chord-sidebar" id="chord-sidebar">
                        <!-- Sticky chord diagrams will be populated here -->
                    </div>
                </div>
                
                <div class="sheet-footer no-print">
                    <p>Generated by Unclelele • <a href="#" id="gigso-link">Try the Gigso App</a></p>
                </div>
                
                <!-- Print-only footer -->
                <div class="print-only-footer print-only">
                    <div class="print-footer-content">
                        <span class="print-url">gigso.net/unclelele</span>
        ...
        const styles = `
            ...
            .song-sheet {
                flex: 1;
                padding: 40px;
                padding-right: 20px; /* Reduced right padding since we have sidebar */
                line-height: 1.6;
            ...
            .chord-sidebar h3 {
                color: var(--unclelele-primary, #2E8B57);
                border-bottom: 2px solid var(--unclelele-accent, #F7931E);
                padding-bottom: 10px;
                margin-bottom: 20px;
                font-size: 1.1em;
                text-align: center;
            ...
            /* Sidebar chord diagrams - stacked vertically */
            .chord-sidebar .chord-diagrams {
                display: flex;
            ...
            .chord-sidebar .chord-diagram-wrapper {
                background: rgba(255, 255, 255, 0.9);
                margin-bottom: 10px;
                transition: transform 0.2s, box-shadow 0.2s;
            }
            
            .chord-sidebar .chord-diagram-wrapper:hover {
                transform: translateY(-2px);
            ...
            @media (max-width: 1024px) {
                ...
                .chord-sidebar {
                    ...
                    position: relative;
                    border-left: none;
                    border-top: 2px solid var(--unclelele-accent, #F7931E);
                    background: rgba(255, 248, 220, 0.5);
                }
    ...
    renderSong() {
        ...
        contentDiv.innerHTML = `
            ...
            <div class="chords-section" style="display: none;">
                <h3>🎼 Chord Diagrams</h3>
                <div class="chord-diagrams" id="chord-diagrams-container">
                    <!-- Chord diagrams will be inserted here for print -->
                </div>
            </div>
            ` : ''}
            ...
            <div class="lyrics-section">
                <h3 class="no-print">🎤 Lyrics & Chords</h3>
        ...
        // Populate the sidebar with chord diagrams
        const sidebarDiv = this.shadowRoot.getElementById('chord-sidebar');
        if (chordDiagrams.length > 0) {
            sidebarDiv.innerHTML = `
                <h3>🎼 Chords</h3>
                <div class="chord-diagrams" id="sidebar-chord-diagrams">
                    <!-- Sidebar chord diagrams will be inserted here -->
                </div>
            `;
            this.renderChordDiagrams(chordDiagrams, true); // true for sidebar
            this.renderChordDiagrams(chordDiagrams, false); // false for print section
        } else {
            sidebarDiv.innerHTML = '<p style="text-align: center; color: #666; font-style: italic;">No chord diagrams available</p>';
        }
    }
    ...
    renderChordDiagrams(chordDiagrams, isSidebar = false) {
        const containerId = isSidebar ? 'sidebar-chord-diagrams' : 'chord-diagrams-container';
